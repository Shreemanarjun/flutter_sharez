...
class Translations implements BaseTranslations<AppLocale, Translations> {
  ...
  String foundDevices({required num n}) => (_root.$meta.cardinalResolver ?? PluralResolvers.cardinal('en'))(
        n,
  ...
  String receiveShareFiles({required num n}) => (_root.$meta.cardinalResolver ?? PluralResolvers.cardinal('en'))(
        n,
  ...
  String shareFiles({required num n}) => (_root.$meta.cardinalResolver ?? PluralResolvers.cardinal('en'))(
        n,
  ...
  dynamic _flatMapFunction(String path) {
    switch (path) {
      ...
      case 'copyAddressTooltip':
        return 'Copy Address';
      case 'copyIpMessage':
        return 'IP Copied to Clipboard';
      case 'copyIpTooltip':
        return 'Copy IP';
      case 'counterAppBarTitle':
        return 'Counter';
      case 'developedBy':
        return 'Developed By Shreeman Arjun \nMade with 💙 Riverpod ';
      case 'dialogActionNo':
        return 'No';
      ...
      case 'noDevicesinNetwork':
        return 'No devices in the network!';
      case 'noFileSelected':
      ...
      case 'ok':
        return 'OK';
      case 'osCopyMessage':
        return 'OS name Copied to Clipboard';
      case 'osLable':
        return 'OS Name';
      case 'osTooltip':
        return 'Copy OS Name';
      case 'osVersionLabel':
        return 'OS Version';
      case 'osVersionMsg':
        return 'OS version Copied to Clipboard';
      case 'osVersiontooltip':
        return 'Copy OS Version';
      case 'portLabel':
        return 'Port';
      case 'portMessage':
        return 'Port Copied to Clipboard';
      case 'portTolltip':
        return 'Copy Port';
      case 'qrScan':
        return 'QR Scan';
      case 'qrscannotSupported':
        return 'QR Scanner not supported in desktop.Please connect manually.';
      case 'receiveLbl':
        return 'Receive';
      case 'report':
        return 'Report';
      ...
      case 'reportDescription':
        return 'If you find bugs/issues or suggestions, please file a report to github issues.';
      case 'rescan':
        return 'Rescan';
      case 'scanningNetwork':
        return 'Scanning all device in your network';
      case 'sendLbl':
        return 'Send';
      case 'sendStateServerStopped':
        return 'Server stopped';
      case 'settingUpServer':
        return 'Setting up server to share your files';
      case 'settingsPage':
        return 'Settings';
      case 'shareInfoMessage':
        return 'You can access the server by following infomation ';
      case 'shareOnWeb':
        return 'Share on Web';
      case 'shareWebMsg':
        return 'Please visit the below link in a browser to acess all you shared files';
      case 'showFiles':
        return 'Show files';
      case 'stopSharing':
        return 'Stop Sharing';
      case 'stopSharingTitle':
        return 'Are you sure to stop sharing?';
      case 'switchTheme':
        return 'Switch Theme';
      case 'wifiWarning':
        return 'Please make sure you have connected to same wifi.';
      default:
        return null;
    }
  }
